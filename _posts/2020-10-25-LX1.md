...
（问题：这个伪迹要不要去掉？有研究称EEG mu波信号不会受到眼动伪迹的影响，只有阿尔法波会受到眨眼，睁眼的影响（需要再查阅一下文献）；以及这里为什么要排除心电图，怎么通过视觉评估排除，本文都未作说明）

在完成上述过程之后，在将运动图像作为基线(baseline)之前（划重点！！直接将运动图像作为基线！！（ASD研究中将无生命物体小球的弹跳作为了基线））
